    ...
    <div className="h-full overflow-y-auto p-8 space-y-8">
      ...
      <div className="space-y-4">
        ...
        {workPackages.map(ap => {
          ...
          return (
            <div key={ap.id} className="bg-white rounded-2xl p-5 border border-gray-200 shadow-soft hover:shadow-medium transition-shadow">
              {/* AP Header */}
      ...
      <div className="space-y-4">
        ...
        {milestones.map(ms => (
          <div key={ms.id} className="bg-white rounded-2xl p-5 border border-gray-200 shadow-soft hover:shadow-medium transition-shadow">
            <div className="flex items-center gap-3 mb-4">
